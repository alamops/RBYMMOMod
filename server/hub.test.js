...
async function main() {
  ...
  try {
    ...
    await dee.ready();
    dee.send('mmo.hello', {
      proto: PROTOCOL, playerId: testPlayerId('DEE'), name: 'DEE', sprite: 'SPRITE_RED',
    ...
    // PROTOCOL 10+ tells the joiner the wait ended (alone) rather than silence
    bob.drain('mmo.coop_offer_end');
