...
// What a move is called, as opposed to what identifies it (PROTOCOL 23). Prose,
...
function cleanBattleMove(raw) {
  ...
  // `name` (PROTOCOL 23) is the one field here that may legitimately be absent
  ...
  // protocol-22 client, whose fight narrates under `id` exactly as it always
