...
// silence. 5 is co-op battles, and the argument decides it a third time: a
// protocol-4 hub has never heard of mmo.coop_wait, so a player would press
// WAIT FOR <friend>, stand there while their partner is never told, and give
// up on a feature working correctly on their own side of the wire. Kept in
// step with Config.PROTOCOL on the mod side.
const PROTOCOL = 5;
